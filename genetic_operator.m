function f  = genetic_operator(parent_chromosome, M, V, mu, mum, l_limit, u_limit, SUL, SDL, I, D,s0,qu,dayflow_r)

%% function f  = genetic_operator(parent_chromosome, M, V, mu, mum, l_limit, u_limit, SUL, SDL, I, D,s0)
% 
...
for i = 1 : N
    ...
    if rand(1) < 0.9
        ...
        child_1(:,V + 1: M + V) = evaluate_objective(child_1,SUL, SDL, I, D,s0,qu,dayflow_r);
        child_2(:,V + 1: M + V) = evaluate_objective(child_2,SUL, SDL, I, D,s0,qu,dayflow_r);
    ...
    % polynomial mutation. 
        ...
        % concatenate the offspring chromosome with objective value.    
        child_3(:,V + 1: M + V) = evaluate_objective(child_3,SUL, SDL, I, D,s0,qu,dayflow_r);
